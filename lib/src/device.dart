part of health;
 ...
 /// A [HKDevice] object corresponds to device information as retrieved from HealthKit.
 class HKDevice {
   ...
   /// Converts a json object to the [HKDevice].
   factory HKDevice.fromJson(json) {
     return HKDevice(
   ...
   /// Converts the [HKDevice] to a json object.
